...
const DgsTregReducer = (state = initialState, action) => {
  switch (action.type) {

    case 'DGS_HOME_TREG_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
    ...
    case 'DGS_HOME_CURRENT_TREG_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'DGS_HOME_CURRENT_TREG_PENDING':
      return{
        ...state, 
      }
    break;

    case 'DGS_HOME_CURRENT_TREG_FULFILLED':
    ...
    case 'DGS_HOME_TREG_PERIODE_REJECTED':
      return{
        ...state, 
        statusErrorFrom:false,
      }
    ...
    case 'DGS_HOME_TREG_PERIODE_PENDING':
      return{
        ...state, 
      }
    break;

    case 'DGS_HOME_TREG_PERIODE_FULFILLED':
