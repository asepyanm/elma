...
class DbsScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      type:'DBS_HOME_TREG',
      payload:axios.get(`${url.API}/ebis_getlopmainytd_treg/startdate/${year}01/enddate/${date}/div/DBS/witel/ALL/treg/ALL`)
    })
  ...
  filterPeriode(data){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API}/ebis_getlopmainytd_treg/startdate/${data.value}/enddate/${data.value}${data.value}/div/DBS/witel/ALL/treg/ALL`)
    });
  }
  ...
  renderFilterRegional(option){
    ...
    if(dataFilter === 'All'){
      this.props.dispatch({
        type:'DBS_HOME_TREG',
        payload:axios.get(`${url.API}/ebis_getlopmainytd_treg/startdate/${date}/enddate/${date}/div/DBS/witel/ALL/treg/ALL`)
      })
  ...
  renderFilterData(option){
    ...
    this.props.dispatch({
      type:'DBS_HOME_TREG',
      payload:axios.get(`${url.API}/ebis_getlopmainytd_treg/startdate/${date}/enddate/${date}/div/DBS/witel/${dataWitel}/treg/${statusRegTreg}`)
    })
