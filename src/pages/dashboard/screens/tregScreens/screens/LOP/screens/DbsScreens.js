  ...
  componentWillMount(){
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getlopmaincurrent_treg/witel/ALL/treg/ALL/div/DBS`)
    })  
  }
    ...
    */
    if(sDataFilter === 'All'){
      ...
      this.props.dispatch({
        ...
        payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getlopmain_ytd/date1/${sDate}/date2/${eDate}/div/DBS/treg/ALL/witel/ALL`)
      })
      ...
      this.props.dispatch({
        ...
        payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getlopmain_ytd/date1/${sDate}/date2/${eDate}/div/DBS/treg/${sStatusRegTreg}/witel/${sDataWitel}`)
      })
      ...
      this.props.dispatch({
        ...
        payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getlopmaincurrent_treg/witel/${sDataWitel}/treg/${sStatusRegTreg}/div/DBS`)
      })
    }
  }
