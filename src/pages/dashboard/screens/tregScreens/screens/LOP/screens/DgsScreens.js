...
class DgsScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      type:'DGS_HOME_TREG',
      payload:axios.get(`${url.API}/ebis_getlopmainytd_treg/startdate/${date1}/enddate/${date2}/div/DGS/witel/ALL/treg/ALL`)
    })
  ...
  filterPeriodeDate1(data){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API}/ebis_getlopmainytd_treg/startdate/${data.value}/enddate/${date2}/div/DGS/witel/ALL/treg/ALL`)
    });
  }
  ...
  filterPeriodeDate2(data){
    ...
    this.props.dispatch({
      type:'DGS_HOME_TREG_PERIODE',
      payload:axios.get(`${url.API}/ebis_getlopmainytd_treg/startdate/${date1}/enddate/${data.value}/div/DGS/witel/ALL/treg/ALL`)
    });
  }
  ...
  renderFilterData(option){
    ...
    this.props.dispatch({
      type:'DGS_HOME_TREG',
      payload:axios.get(`${url.API}/ebis_getlopmainytd_treg/startdate/${date1}/enddate/${date2}/div/DGS/witel/${dataWitel}/treg/${statusRegTreg}`)
    })
