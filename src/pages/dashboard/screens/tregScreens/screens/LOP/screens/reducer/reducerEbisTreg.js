...
const EbisTregReducer = (state = initialState, action) => {
  switch (action.type) {

    case 'EBIS_HOME_TREG_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
    ...
    case 'EBIS_HOME_CURRENT_TREG_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'EBIS_HOME_CURRENT_TREG_PENDING':
      return{
        ...state, 
      }
    break;

    case 'EBIS_HOME_CURRENT_TREG_FULFILLED':
    ...
    case 'EBIS_HOME_TREG_PERIODE_REJECTED':
      return{
        ...state, 
        statusErrorFrom:false,
      }
    ...
    case 'EBIS_HOME_TREG_PERIODE_PENDING':
      return{
        ...state, 
      }
    break;

    case 'EBIS_HOME_TREG_PERIODE_FULFILLED':
...
export default EbisTregReducer;