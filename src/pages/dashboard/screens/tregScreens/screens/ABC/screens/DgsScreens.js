...
class DgsScreens extends Component{
  ...
  componentWillMount(){
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getlopmainabc_treg/witel/ALL/treg/ALL/div/DGS`)
    })
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getlopmaincurrentabc_treg/witel/ALL/treg/ALL/div/DGS`)
    })
  }
  ...
  renderFilterData(option){
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getlopmainabc_treg/witel/${dataWitel}/treg/${statusRegTreg}/div/DGS`)
    })
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getlopmaincurrentabc_treg/witel/${dataWitel}/treg/${statusRegTreg}/div/DGS`)
    })
  }
