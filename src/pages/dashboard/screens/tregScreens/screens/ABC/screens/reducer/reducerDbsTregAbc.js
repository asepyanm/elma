...
const DbsTregReducerABC = (state = initialState, action) => {
  switch (action.type) {

    case 'DBS_ABC_TREG_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
    ...
    case 'DBS_CURRENT_ABC_TREG_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'DBS_CURRENT_ABC_TREG_PENDING':
      return{
        ...state, 
      }
    break;
...
export default DbsTregReducerABC;