...
const DesTregReducerABC = (state = initialState, action) => {
  switch (action.type) {

    case 'DES_ABC_TREG_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
    ...
    case 'DES_CURRENT_ABC_TREG_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'DES_CURRENT_ABC_TREG_PENDING':
      return{
        ...state, 
      }
    break;

    case 'DES_CURRENT_ABC_TREG_FULFILLED':
...
export default DesTregReducerABC;