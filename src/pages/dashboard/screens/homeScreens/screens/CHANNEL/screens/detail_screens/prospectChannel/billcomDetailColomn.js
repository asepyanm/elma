...
class EbisDetailColumnProspectScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/EBIS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DES',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DES/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DBS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DBS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DGS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DGS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail SUBS
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_EBIS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/EBIS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DES',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DES/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DBS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DBS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DGS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DGS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail MITRA
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_EBIS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/EBIS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_DES',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DES/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_DBS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DBS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_DGS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DGS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    
    //get data detail TELKOM
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_EBIS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/EBIS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DES',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DES/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DBS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DBS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DGS',
      payload:axios.get(`${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/${nameChannel}/div/DGS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
  }
  ...
  _toggleModal(item,div,maindiv){
    ...
    axios.get(`${url.API2}/ebis_getdeallistcc/stage/BILLCOM/categ/${maindiv}/channel/${nameChannel}/div/${div}/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`).then((res) => {
    ...
    return(
      ...
      <View style={{backgroundColor:'#FFF', flex:1}}>
        <View style={styles.wrapperArrow}>
					<View style={{backgroundColor:'#a9c1fb'}}>
...
const mapStateToProps = (state) => ({
  //data ebis
  ebisPROSPECT_GTMA: state.EbisReducerChannel.ebisBILLCOM_GTMA,
  ebisPROSPECT_GTMA_PROJECT: state.EbisReducerChannel.ebisBILLCOM_GTMA_PROJECT,
  ebisPROSPECT_NGTMA: state.EbisReducerChannel.ebisBILLCOM_NGTMA,
  ebisPROSPECT_NGTMA_PROJECT: state.EbisReducerChannel.ebisBILLCOM_NGTMA_PROJECT,
  ebisPROSPECT_OC: state.EbisReducerChannel.ebisBILLCOM_OC,
  ebisPROSPECT_OC_PROJECT: state.EbisReducerChannel.ebisBILLCOM_OC_PROJECT,

  //data des
  desPROSPECT_GTMA: state.DesReducerChannel.ebisBILLCOM_GTMA,
  desPROSPECT_GTMA_PROJECT: state.DesReducerChannel.ebisBILLCOM_GTMA_PROJECT,
  desPROSPECT_NGTMA: state.DesReducerChannel.ebisBILLCOM_NGTMA,
  desPROSPECT_NGTMA_PROJECT: state.DesReducerChannel.ebisBILLCOM_NGTMA_PROJECT,
  desPROSPECT_OC: state.DesReducerChannel.ebisBILLCOM_OC,
  desPROSPECT_OC_PROJECT: state.DesReducerChannel.ebisBILLCOM_OC_PROJECT,

  //data dbs
  dbsPROSPECT_GTMA: state.DbsReducerChannel.ebisBILLCOM_GTMA,
  dbsPROSPECT_GTMA_PROJECT: state.DbsReducerChannel.ebisBILLCOM_GTMA_PROJECT,
  dbsPROSPECT_NGTMA: state.DbsReducerChannel.ebisBILLCOM_NGTMA,
  dbsPROSPECT_NGTMA_PROJECT: state.DbsReducerChannel.ebisBILLCOM_NGTMA_PROJECT,
  dbsPROSPECT_OC: state.DbsReducerChannel.ebisBILLCOM_OC,
  dbsPROSPECT_OC_PROJECT: state.DbsReducerChannel.ebisBILLCOM_OC_PROJECT,

  //data dgs
  dgsPROSPECT_GTMA: state.DgsReducerChannel.ebisBILLCOM_GTMA,
  dgsPROSPECT_GTMA_PROJECT: state.DgsReducerChannel.ebisBILLCOM_GTMA_PROJECT,
  dgsPROSPECT_NGTMA: state.DgsReducerChannel.ebisBILLCOM_NGTMA,
  dgsPROSPECT_NGTMA_PROJECT: state.DgsReducerChannel.ebisBILLCOM_NGTMA_PROJECT,
  dgsPROSPECT_OC: state.DgsReducerChannel.ebisBILLCOM_OC,
  dgsPROSPECT_OC_PROJECT: state.DgsReducerChannel.ebisBILLCOM_OC_PROJECT,
