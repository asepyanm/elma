...
class detailMonitorProgressOgp7 extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_7',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_7_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_7_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_7_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/7`)
    })

    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_7',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_7_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_7_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_7_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/7`)
    })

    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_7',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_7_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_7_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_7_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/7`)
    })

    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_7',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_7_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_7_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_7_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/7`)
    })
  ...
  _toggleModal(div,nmitra,mitra){
    ...
    axios.get(`${url.API}/ebis_getkbproject/div/${div}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/range/7/nmitra/${nmitra}/mitra/${mitra}`).then((res) => {
    ...
    return (
      <Container style={styles.container}>
        <Header style={{ backgroundColor: '#820000' }}>
          ...
          <Body>
            <Title style={{ color: '#FFF' }}>OGP KB &#62; 7 Hari</Title>
          </Body>
          <Right />
        </Header>
...
const mapStateToProps = (state) => ({
  ...
  //EBIS
  EbisProspectRev: state.MonitorEbisReducer.dataOgp7Rev,
  EbisProspectProject: state.MonitorEbisReducer.dataOgp7Project,

  //DES
  DesProspectRev: state.MonitorDesReducer.dataOgp7Rev,
  DesProspectProject: state.MonitorDesReducer.dataOgp7Project,

  //DBS
  DbsProspectRev: state.MonitorDbsReducer.dataOgp7Rev,
  DbsProspectProject: state.MonitorDbsReducer.dataOgp7Project,

  //DGS
  DgsProspectRev: state.MonitorDgsReducer.dataOgp7Rev,
  DgsProspectProject: state.MonitorDgsReducer.dataOgp7Project,

  //detail Ogp
  EbisDetailOgp: state.MonitorEbisReducer.detailOgp7,
  EbisDetailOgpSubs: state.MonitorEbisReducer.detailOgp7Subs,
  EbisDetailOgpMitra: state.MonitorEbisReducer.detailOgp7Mitra,
  EbisDetailOgpTelkom: state.MonitorEbisReducer.detailOgp7Telkom,

  DesDetailOgp: state.MonitorDesReducer.detailOgp7,
  DesDetailOgpSubs: state.MonitorDesReducer.detailOgp7Subs,
  DesDetailOgpMitra: state.MonitorDesReducer.detailOgp7Mitra,
  DesDetailOgpTelkom: state.MonitorDesReducer.detailOgp7Telkom,

  DbsDetailOgp: state.MonitorDbsReducer.detailOgp7,
  DbsDetailOgpSubs: state.MonitorDbsReducer.detailOgp7Subs,
  DbsDetailOgpMitra: state.MonitorDbsReducer.detailOgp7Mitra,
  DbsDetailOgpTelkom: state.MonitorDbsReducer.detailOgp7Telkom,

  DgsDetailOgp: state.MonitorDgsReducer.detailOgp7,
  DgsDetailOgpSubs: state.MonitorDgsReducer.detailOgp7Subs,
  DgsDetailOgpMitra: state.MonitorDgsReducer.detailOgp7Mitra,
  DgsDetailOgpTelkom: state.MonitorDgsReducer.detailOgp7Telkom,

})

export default connect(mapStateToProps)(detailMonitorProgressOgp7);
