...
class DbsDetailScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/EBIS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DES/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DBS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DGS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/EBIS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DES/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DBS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DGS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/EBIS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DES/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DBS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DGS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/EBIS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DES/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DBS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/BILLCOM/channel/ALL/div/DGS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    }); 
  ...
  _toggleModal(item,div,maindiv){
    ...
    RNFetchBlob.config({
      trusty:true
    }). fetch('GET', `${url.API2}/ebis_getdeallistcc/stage/BILLCOM/categ/${maindiv}/channel/ALL/div/${div}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`)
    .then((res) => {
