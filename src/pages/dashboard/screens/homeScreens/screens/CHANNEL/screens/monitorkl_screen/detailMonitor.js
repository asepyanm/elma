...
class detailMonitorKL extends Component{
  constructor(props){
    super(props);
    this.state = {
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      //payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/DONE/nmitra/TELKOM`)
    })
    ...
    this.props.dispatch({
      ...
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/DONE/nmitra/TELKOM`)
    })
    ...
    this.props.dispatch({
      ...
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/DONE/nmitra/TELKOM`)
    })
    ...
    this.props.dispatch({
      ...
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/DONE/nmitra/ALL/nmitra/TELKOM`)
    })
...
const mapStateToProps = (state) => ({
  //EBIS
  ebisWinRev: state.MonitorEbisReducerKL.dataEbisDoneWinSubs,
  ebisWinProject: state.MonitorEbisReducerKL.dataEbisDoneWPSubs,
  
  //DES
  desWinRev: state.MonitorDesReducerKL.dataDesDoneWinSubs,
  desWinProject: state.MonitorDesReducerKL.dataDesDoneWPSubs,

  //DBS
  dbsWinRev: state.MonitorDbsReducerKL.dataDbsDoneWinSubs,
  dbsWinProject: state.MonitorDbsReducerKL.dataDbsDoneWPSubs,

  //DGS
  dgsWinRev: state.MonitorDgsReducerKL.dataDgsDoneWinSubs,
  dgsWinProject: state.MonitorDgsReducerKL.dataDgsDoneWPSubs,

  //detail done
  ebisDetailDone: state.MonitorEbisReducerKL.detailDone,
  ebisDetailDoneSubs: state.MonitorEbisReducerKL.detailDoneSubs,
  ebisDetailDoneMitra: state.MonitorEbisReducerKL.detailDoneMitra,
  ebisDetailDoneTelkom: state.MonitorEbisReducerKL.detailDoneTelkom,

  desDetailDone: state.MonitorDesReducerKL.detailDone,
  desDetailDoneSubs: state.MonitorDesReducerKL.detailDoneSubs,
  desDetailDoneMitra: state.MonitorDesReducerKL.detailDoneMitra,
  desDetailDoneTelkom: state.MonitorDesReducerKL.detailDoneTelkom,

  dbsDetailDone: state.MonitorDbsReducerKL.detailDone,
  dbsDetailDoneSubs: state.MonitorDbsReducerKL.detailDoneSubs,
  dbsDetailDoneMitra: state.MonitorDbsReducerKL.detailDoneMitra,
  dbsDetailDoneTelkom: state.MonitorDbsReducerKL.detailDoneTelkom,

  dgsDetailDone: state.MonitorDgsReducerKL.detailDone,
  dgsDetailDoneSubs: state.MonitorDgsReducerKL.detailDoneSubs,
  dgsDetailDoneMitra: state.MonitorDgsReducerKL.detailDoneMitra,
  dgsDetailDoneTelkom: state.MonitorDgsReducerKL.detailDoneTelkom,

})

export default connect(mapStateToProps)(detailMonitorKL);
