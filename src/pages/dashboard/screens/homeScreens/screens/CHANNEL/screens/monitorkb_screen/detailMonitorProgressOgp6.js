...
class detailMonitorProgressOgp6 extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_6',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_6_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_6_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_6_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/6`)
    })

    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_6',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_6_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_6_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_6_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/6`)
    })

    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_6',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_6_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_6_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_6_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/6`)
    })

    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_6',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_6_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_6_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/6`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_6_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/6`)
    })
  ...
  _toggleModal(div,nmitra,mitra){
    ...
    axios.get(`${url.API}/ebis_getkbproject/div/${div}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/range/6/nmitra/${nmitra}/mitra/${mitra}`).then((res) => {
...
const mapStateToProps = (state) => ({
  ...
  //EBIS
  EbisProspectRev: state.MonitorEbisReducer.dataOgp6Rev,
  EbisProspectProject: state.MonitorEbisReducer.dataOgp6Project,

  //DES
  DesProspectRev: state.MonitorDesReducer.dataOgp6Rev,
  DesProspectProject: state.MonitorDesReducer.dataOgp6Project,

  //DBS
  DbsProspectRev: state.MonitorDbsReducer.dataOgp6Rev,
  DbsProspectProject: state.MonitorDbsReducer.dataOgp6Project,

  //DGS
  DgsProspectRev: state.MonitorDgsReducer.dataOgp6Rev,
  DgsProspectProject: state.MonitorDgsReducer.dataOgp6Project,

  //detail Ogp
  EbisDetailOgp: state.MonitorEbisReducer.detailOgp6,
  EbisDetailOgpSubs: state.MonitorEbisReducer.detailOgp6Subs,
  EbisDetailOgpMitra: state.MonitorEbisReducer.detailOgp6Mitra,
  EbisDetailOgpTelkom: state.MonitorEbisReducer.detailOgp6Telkom,

  DesDetailOgp: state.MonitorDesReducer.detailOgp6,
  DesDetailOgpSubs: state.MonitorDesReducer.detailOgp6Subs,
  DesDetailOgpMitra: state.MonitorDesReducer.detailOgp6Mitra,
  DesDetailOgpTelkom: state.MonitorDesReducer.detailOgp6Telkom,

  DbsDetailOgp: state.MonitorDbsReducer.detailOgp6,
  DbsDetailOgpSubs: state.MonitorDbsReducer.detailOgp6Subs,
  DbsDetailOgpMitra: state.MonitorDbsReducer.detailOgp6Mitra,
  DbsDetailOgpTelkom: state.MonitorDbsReducer.detailOgp6Telkom,

  DgsDetailOgp: state.MonitorDgsReducer.detailOgp6,
  DgsDetailOgpSubs: state.MonitorDgsReducer.detailOgp6Subs,
  DgsDetailOgpMitra: state.MonitorDgsReducer.detailOgp6Mitra,
  DgsDetailOgpTelkom: state.MonitorDgsReducer.detailOgp6Telkom,

})

export default connect(mapStateToProps)(detailMonitorProgressOgp6);
