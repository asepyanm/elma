...
class EbisDetailColumnProspectScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/EBIS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DES/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DBS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DGS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/EBIS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DES/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DBS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DGS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/EBIS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DES/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DBS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DGS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/EBIS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DES/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DBS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getchannellistsub/stage/SUBMISSION/channel/${nameChannel}/div/DGS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
  ...
  _toggleModal(item,div,maindiv){
    ...
    RNFetchBlob.config({
      trusty:true
    }). fetch('GET', `${url.API2}/ebis_getchannellistcc/stage/SUBMISSION/categ/${maindiv}/channel/${nameChannel}/div/${div}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`)
    .then((res) => {
  ...
  _toggleModalTelkom(item,div,maindiv){
    ...
    RNFetchBlob.config({
      trusty:true
    }). fetch('GET', `${url.API2}/ebis_getdeallistcc/stage/SUBMISSION/categ/${maindiv}/channel/${nameChannel}/div/${div}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`)
    .then((res) => {
      this.setState({dataTampung:res.data, loaderTampilDetail:false });
    }).catch((err) => {
      this.setState({
...
const mapStateToProps = (state) => ({
  //data ebis
  ebisPROSPECT_GTMA: state.EbisReducerChannel.ebisSUBMISSION_GTMA,
  ebisPROSPECT_GTMA_PROJECT: state.EbisReducerChannel.ebisSUBMISSION_GTMA_PROJECT,
  ebisPROSPECT_NGTMA: state.EbisReducerChannel.ebisSUBMISSION_NGTMA,
  ebisPROSPECT_NGTMA_PROJECT: state.EbisReducerChannel.ebisSUBMISSION_NGTMA_PROJECT,
  ebisPROSPECT_OC: state.EbisReducerChannel.ebisSUBMISSION_OC,
  ebisPROSPECT_OC_PROJECT: state.EbisReducerChannel.ebisSUBMISSION_OC_PROJECT,

  //data des
  desPROSPECT_GTMA: state.DesReducerChannel.ebisSUBMISSION_GTMA,
  desPROSPECT_GTMA_PROJECT: state.DesReducerChannel.ebisSUBMISSION_GTMA_PROJECT,
  desPROSPECT_NGTMA: state.DesReducerChannel.ebisSUBMISSION_NGTMA,
  desPROSPECT_NGTMA_PROJECT: state.DesReducerChannel.ebisSUBMISSION_NGTMA_PROJECT,
  desPROSPECT_OC: state.DesReducerChannel.ebisSUBMISSION_OC,
  desPROSPECT_OC_PROJECT: state.DesReducerChannel.ebisSUBMISSION_OC_PROJECT,

  //data dbs
  dbsPROSPECT_GTMA: state.DbsReducerChannel.ebisSUBMISSION_GTMA,
  dbsPROSPECT_GTMA_PROJECT: state.DbsReducerChannel.ebisSUBMISSION_GTMA_PROJECT,
  dbsPROSPECT_NGTMA: state.DbsReducerChannel.ebisSUBMISSION_NGTMA,
  dbsPROSPECT_NGTMA_PROJECT: state.DbsReducerChannel.ebisSUBMISSION_NGTMA_PROJECT,
  dbsPROSPECT_OC: state.DbsReducerChannel.ebisSUBMISSION_OC,
  dbsPROSPECT_OC_PROJECT: state.DbsReducerChannel.ebisSUBMISSION_OC_PROJECT,

  //data dgs
  dgsPROSPECT_GTMA: state.DgsReducerChannel.ebisSUBMISSION_GTMA,
  dgsPROSPECT_GTMA_PROJECT: state.DgsReducerChannel.ebisSUBMISSION_GTMA_PROJECT,
  dgsPROSPECT_NGTMA: state.DgsReducerChannel.ebisSUBMISSION_NGTMA,
  dgsPROSPECT_NGTMA_PROJECT: state.DgsReducerChannel.ebisSUBMISSION_NGTMA_PROJECT,
  dgsPROSPECT_OC: state.DgsReducerChannel.ebisSUBMISSION_OC,
  dgsPROSPECT_OC_PROJECT: state.DgsReducerChannel.ebisSUBMISSION_OC_PROJECT,
