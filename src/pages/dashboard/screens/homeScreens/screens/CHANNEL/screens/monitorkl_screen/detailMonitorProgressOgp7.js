...
class detailMonitorProgressOgp7KL extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      type: 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_7',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_7_SUBS',
      payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_7_MITRA',
      payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_7_TELKOM',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/7`)
    })

    this.props.dispatch({
      type: 'MONITOR_KL_DES_DETAIL_OGP_PROGRESS_7',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DES_DETAIL_OGP_PROGRESS_7_SUBS',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DES_DETAIL_OGP_PROGRESS_7_MITRA',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DES_DETAIL_OGP_PROGRESS_7_TELKOM',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/7`)
    })

    this.props.dispatch({
      type: 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_7',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_7_SUBS',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_7_MITRA',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_7_TELKOM',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/7`)
    })

    this.props.dispatch({
      type: 'MONITOR_KL_DGS_DETAIL_OGP_PROGRESS_7',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DGS_DETAIL_OGP_PROGRESS_7_SUBS',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DGS_DETAIL_OGP_PROGRESS_7_MITRA',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/7`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DGS_DETAIL_OGP_PROGRESS_7_TELKOM',
      //ayload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/7`)
    })
  ...
  _toggleModal(div,nmitra,mitra){
    ...
    axios.get(`${url.API}/ebis_getklproject/div/${div}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/range/7/nmitra/${nmitra}/mitra/${mitra}`).then((res) => {
  ...
  _onDataPress(level, mitra, id) {
    ...
    axios.get(`${url.API}/ebis_getklproject/div/${level.level}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/mitra/${level.mitra}/idproject/${level.id}`).then((res) => {
    ...
    return (
      <Container style={styles.container}>
        <Header style={{ backgroundColor: '#820000' }}>
          ...
          <Body>
            <Title style={{ color: '#FFF' }}>OGP KL &#62; 7 Hari</Title>
          </Body>
          <Right />
        </Header>
...
const mapStateToProps = (state) => ({
  ...
  //EBIS
  ebisWinRev: state.MonitorEbisReducerKL.dataOgp7RevSubs,
  ebisWinProject: state.MonitorEbisReducerKL.dataOgp7ProjectSubs,
  
  //DES
  desWinRev: state.MonitorDesReducerKL.dataOgp7RevSubs,
  desWinProject: state.MonitorDesReducerKL.dataOgp7ProjectSubs,

  //DBS
  dbsWinRev: state.MonitorDbsReducerKL.dataOgp7RevSubs,
  dbsWinProject: state.MonitorDbsReducerKL.dataOgp7ProjectSubs,

  //DGS
  dgsWinRev: state.MonitorDgsReducerKL.dataOgp7RevSubs,
  dgsWinProject: state.MonitorDgsReducerKL.dataOgp7ProjectSubs,

  //detail Ogp
  EbisDetailOgp: state.MonitorEbisReducerKL.detailOgp7,
  EbisDetailOgpSubs: state.MonitorEbisReducerKL.detailOgp7Subs,
  EbisDetailOgpMitra: state.MonitorEbisReducerKL.detailOgp7Mitra,
  EbisDetailOgpTelkom: state.MonitorEbisReducerKL.detailOgp7Telkom,

  DesDetailOgp: state.MonitorDesReducerKL.detailOgp7,
  DesDetailOgpSubs: state.MonitorDesReducerKL.detailOgp7Subs,
  DesDetailOgpMitra: state.MonitorDesReducerKL.detailOgp7Mitra,
  DesDetailOgpTelkom: state.MonitorDesReducerKL.detailOgp7Telkom,

  DbsDetailOgp: state.MonitorDbsReducerKL.detailOgp7,
  DbsDetailOgpSubs: state.MonitorDbsReducerKL.detailOgp7Subs,
  DbsDetailOgpMitra: state.MonitorDbsReducerKL.detailOgp7Mitra,
  DbsDetailOgpTelkom: state.MonitorDbsReducerKL.detailOgp7Telkom,

  DgsDetailOgp: state.MonitorDgsReducerKL.detailOgp7,
  DgsDetailOgpSubs: state.MonitorDgsReducerKL.detailOgp7Subs,
  DgsDetailOgpMitra: state.MonitorDgsReducerKL.detailOgp7Mitra,
  DgsDetailOgpTelkom: state.MonitorDgsReducerKL.detailOgp7Telkom,

})

export default connect(mapStateToProps)(detailMonitorProgressOgp7KL);
