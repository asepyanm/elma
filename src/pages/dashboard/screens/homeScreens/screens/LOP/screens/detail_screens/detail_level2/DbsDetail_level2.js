...
class DbsDetailScreens extends Component{
  ...
  componentWillMount(){
    ...
    axios.get(`${url.API}/ebis_getstage5/stage/WIN/div/${dataDivisi}/maindiv/${dataDivisi}/mitra/${dataKategoriMitra}/nmitra/${dataMitraDetail}/mainseg/ALL/start_date/${date1}/end_date/${date2}`).then((res) => {
  ...
  _toggleModal(item){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API}/ebis_getstage5/stage/WIN/div/${dataDivisi}/maindiv/${dataDivisi}/mitra/${dataKategoriMitra}/nmitra/${dataMitraDetail}/mainseg/ALL/start_date/${date1}/end_date/${date2}/cc/${item.stage_06}`)
    });
  }
  renderModalContent(){
...
const mapStateToProps = (state) => ({
  ...
  //data detail level 3
  loaderStatus:state.DbsDetailReducer.loaderStatus,
  dataDetailLevel3:state.DbsDetailReducer.dataDetailLevel3
})
