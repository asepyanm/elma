...
class DgsDetailScreens extends Component{
  constructor(props){
    super(props);
  ...
  componentWillMount(){
    ...
    axios.get(`${url.API}/ebis_getstage5/stage/BILLCOM/div/${dataDivisi}/maindiv/${dataDivisi}/mitra/${dataKategoriMitra}/nmitra/${dataMitraDetail}/mainseg/ALL/start_date/${date1}/end_date/${date2}`).then((res) => {
  ...
  _toggleModal(item){
    ...
    this.props.dispatch({
      type:'DETAIL_LEVEL_3_DBS',
      payload:axios.get(`${url.API}/ebis_getstage5/stage/BILLCOM/div/${dataDivisi}/maindiv/${dataDivisi}/mitra/${dataKategoriMitra}/nmitra/${dataMitraDetail}/mainseg/ALL/start_date/${date1}/end_date/${date2}/cc/${item.stage_06}`)
    });
  }
  renderModalContent(){
...
const mapStateToProps = (state) => ({
  ...
  //data detail level 3
  loaderStatus:state.DgsDetailReducer.loaderStatus,
  dataDetailLevel3:state.DgsDetailReducer.dataDetailLevel3
})

export default connect(mapStateToProps)(DgsDetailScreens);
