...
class DesScreens extends Component{
  ...
  filterPeriodeDate1(data){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API}/ebis_getlopmain_ytd/div/DES/date1/${data.value}/date2/${date2}`)
    });
  }
  ...
  filterPeriodeDate2(data){
    ...
    this.props.dispatch({
      type:'DES_HOME_FILTER_PERIODE',
      payload:axios.get(`${url.API}/ebis_getlopmain_ytd/div/DES/date1/${date1}/date2/${data.value}`)
    });
  }
