...
class detailMonitorProgressOgp3 extends Component {
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_3_TELKOM',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })
    ...
    this.props.dispatch({
      ...
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_3_SUBS',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_3_MITRA',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_3_TELKOM',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })
    ...
    this.props.dispatch({
      ...
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_3_TELKOM',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })
    ...
    this.props.dispatch({
      ...
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_3_TELKOM',
      payload:  RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })
  ...
  _toggleModal(div,nmitra,mitra){
    ...
    RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbproject/div/${div}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/range/3/nmitra/${nmitra}/mitra/${mitra}`).then((res) => {
  ...
  _onDataPress(level, mitra, id) {
    ...
    RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getkbproject/div/${level.level}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/mitra/${level.mitra}/idproject/${level.id}`).then((res) => {
