...
class detailMonitorProgressOgp3 extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount(){
    ...
    //EBIS DETAIL OGP PROGRESS
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_3',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_EBIS_DETAIL_OGP_PROGRESS_3_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })

    //DES DETAIL OGP PROGRESS
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_3',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_3_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_3_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DES_DETAIL_OGP_PROGRESS_3_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })

    //DBS DETAIL OGP PROGRESS
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_3',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DBS_DETAIL_OGP_PROGRESS_3_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })

    //DGS DETAIL OGP PROGRESS
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_3',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KB_DGS_DETAIL_OGP_PROGRESS_3_TELKOM',
      payload: axios.get(`${url.API}/ebis_getkbcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })
  ...
  _toggleModal(div,nmitra,mitra){
    ...
    axios.get(`${url.API}/ebis_getkbproject/div/${div}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/range/3/nmitra/${nmitra}/mitra/${mitra}`).then((res) => {
  ...
  _onDataPress(level, mitra, id) {
    ...
    axios.get(`${url.API}/ebis_getkbproject/div/${level.level}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/mitra/${level.mitra}/idproject/${level.id}`).then((res) => {
    ...
    return (
      <Container style={styles.container}>
        <Header style={{ backgroundColor: '#820000' }}>
          ...
          <Body>
            <Title style={{ color: '#FFF' }}>OGP KB &#60; 3 Hari</Title>
          </Body>
          <Right />
        </Header>
...
const mapStateToProps = (state) => ({
  ...
  //EBIS
  EbisProspectRev: state.MonitorEbisReducer.dataOgp3Rev,
  EbisProspectProject: state.MonitorEbisReducer.dataOgp3Project,

  //DES
  DesProspectRev: state.MonitorDesReducer.dataOgp3Rev,
  DesProspectProject: state.MonitorDesReducer.dataOgp3Project,

  //DBS
  DbsProspectRev: state.MonitorDbsReducer.dataOgp3Rev,
  DbsProspectProject: state.MonitorDbsReducer.dataOgp3Project,

  //DGS
  DgsProspectRev: state.MonitorDgsReducer.dataOgp3Rev,
  DgsProspectProject: state.MonitorDgsReducer.dataOgp3Project,

  //detail Ogp
  EbisDetailOgp: state.MonitorEbisReducer.detailOgp3,
  EbisDetailOgpSubs: state.MonitorEbisReducer.detailOgp3Subs,
  EbisDetailOgpMitra: state.MonitorEbisReducer.detailOgp3Mitra,
  EbisDetailOgpTelkom: state.MonitorEbisReducer.detailOgp3Telkom,

  DesDetailOgp: state.MonitorDesReducer.detailOgp3,
  DesDetailOgpSubs: state.MonitorDesReducer.detailOgp3Subs,
  DesDetailOgpMitra: state.MonitorDesReducer.detailOgp3Mitra,
  DesDetailOgpTelkom: state.MonitorDesReducer.detailOgp3Telkom,

  DbsDetailOgp: state.MonitorDbsReducer.detailOgp3,
  DbsDetailOgpSubs: state.MonitorDbsReducer.detailOgp3Subs,
  DbsDetailOgpMitra: state.MonitorDbsReducer.detailOgp3Mitra,
  DbsDetailOgpTelkom: state.MonitorDbsReducer.detailOgp3Telkom,

  DgsDetailOgp: state.MonitorDgsReducer.detailOgp3,
  DgsDetailOgpSubs: state.MonitorDgsReducer.detailOgp3Subs,
  DgsDetailOgpMitra: state.MonitorDgsReducer.detailOgp3Mitra,
  DgsDetailOgpTelkom: state.MonitorDgsReducer.detailOgp3Telkom,

})

export default connect(mapStateToProps)(detailMonitorProgressOgp3);
