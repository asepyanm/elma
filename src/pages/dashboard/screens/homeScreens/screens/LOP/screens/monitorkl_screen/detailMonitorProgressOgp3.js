...
class detailMonitorProgressOgp3KL extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      type: 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_3',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_3_TELKOM',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/EBIS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })

    this.props.dispatch({
      type: 'MONITOR_KL_DES_DETAIL_OGP_PROGRESS_3',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DES_DETAIL_OGP_PROGRESS_3_SUBS',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DES_DETAIL_OGP_PROGRESS_3_MITRA',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DES_DETAIL_OGP_PROGRESS_3_TELKOM',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DES/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })

    this.props.dispatch({
      type: 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_3',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DBS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_3_TELKOM',
     // payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })

    this.props.dispatch({
      type: 'MONITOR_KL_DGS_DETAIL_OGP_PROGRESS_3',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/ALL/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DGS_DETAIL_OGP_PROGRESS_3_SUBS',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/CFU/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DGS_DETAIL_OGP_PROGRESS_3_MITRA',
      payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/MITRA/range/3`)
    })
    this.props.dispatch({
      type: 'MONITOR_KL_DGS_DETAIL_OGP_PROGRESS_3_TELKOM',
      //payload: axios.get(`${url.API}/ebis_getklcc/div/DGS/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/nmitra/TELKOM/range/3`)
    })
  ...
  _toggleModal(div,nmitra,mitra){
    ...
    axios.get(`${url.API}/ebis_getklproject/div/${div}/treg/${this.state.treg}/witel/${this.state.witel}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/state/OGP/range/3/nmitra/${nmitra}/mitra/${mitra}`).then((res) => {
    ...
    return (
      <Container style={styles.container}>
        <Header style={{ backgroundColor: '#820000' }}>
          ...
          <Body>
            <Title style={{ color: '#FFF' }}>OGP KL &#60; 3 Hari</Title>
          </Body>
          <Right />
        </Header>
...
const mapStateToProps = (state) => ({
  ...
  //EBIS
  EbisProspectRev: state.MonitorEbisReducerKL.dataOgp3RevSubs,
  EbisProspectProject: state.MonitorEbisReducerKL.dataOgp3ProjectSubs,

  //DES
  DesProspectRev: state.MonitorDesReducerKL.dataOgp3RevSubs,
  DesProspectProject: state.MonitorDesReducerKL.dataOgp3ProjectSubs,

  //DBS
  DbsProspectRev: state.MonitorDbsReducerKL.dataOgp3RevSubs,
  DbsProspectProject: state.MonitorDbsReducerKL.dataOgp3ProjectSubs,

  //DGS
  DgsProspectRev: state.MonitorDgsReducerKL.dataOgp3RevSubs,
  DgsProspectProject: state.MonitorDgsReducerKL.dataOgp3ProjectSubs,

  //detail Ogp
  EbisDetailOgp: state.MonitorEbisReducerKL.detailOgp3,
  EbisDetailOgpSubs: state.MonitorEbisReducerKL.detailOgp3Subs,
  EbisDetailOgpMitra: state.MonitorEbisReducerKL.detailOgp3Mitra,
  EbisDetailOgpTelkom: state.MonitorEbisReducerKL.detailOgp3Telkom,

  DesDetailOgp: state.MonitorDesReducerKL.detailOgp3,
  DesDetailOgpSubs: state.MonitorDesReducerKL.detailOgp3Subs,
  DesDetailOgpMitra: state.MonitorDesReducerKL.detailOgp3Mitra,
  DesDetailOgpTelkom: state.MonitorDesReducerKL.detailOgp3Telkom,

  DbsDetailOgp: state.MonitorDbsReducerKL.detailOgp3,
  DbsDetailOgpSubs: state.MonitorDbsReducerKL.detailOgp3Subs,
  DbsDetailOgpMitra: state.MonitorDbsReducerKL.detailOgp3Mitra,
  DbsDetailOgpTelkom: state.MonitorDbsReducerKL.detailOgp3Telkom,

  DgsDetailOgp: state.MonitorDgsReducerKL.detailOgp3,
  DgsDetailOgpSubs: state.MonitorDgsReducerKL.detailOgp3Subs,
  DgsDetailOgpMitra: state.MonitorDgsReducerKL.detailOgp3Mitra,
  DgsDetailOgpTelkom: state.MonitorDgsReducerKL.detailOgp3Telkom,

})

export default connect(mapStateToProps)(detailMonitorProgressOgp3KL);
