...
const mapStateToProps = (state) => ({
  lastUpdated: state.DesReducerBMDebisLastupdate,

  //data des
  ebisProspectREVENUE:state.DesReducerBMD.ebisProspectREVENUE,
  ebisProspectProject:state.DesReducerBMD.ebisProspectProject,
  ebisPROSPECT_GTMA: state.DesReducerBMD.ebisPROSPECT_GTMA,
  ebisPROSPECT_GTMA_PROJECT: state.DesReducerBMD.ebisPROSPECT_GTMA_PROJECT,
  PROSPECT_OC: state.DesReducerBMD.PROSPECT_OC,
  PROSPECT_OC_PROJECT: state.DesReducerBMD.PROSPECT_OC_PROJECT,

  ebisSubmisionREVENUE:state.DesReducerBMD.ebisSubmisionREVENUE,
  ebisSubmissionProject:state.DesReducerBMD.ebisSubmissionProject,
  ebisSUBMISSION_GTMA:state.DesReducerBMD.ebisSUBMISSION_GTMA,
  ebisSUBMISSION_GTMA_PROJECT:state.DesReducerBMD.ebisSUBMISSION_GTMA_PROJECT,
  ebisSUBMISSION_OC: state.DesReducerBMD.ebisSUBMISSION_OC,
  ebisSUBMISSION_OC_PROJECT: state.DesReducerBMD.ebisSUBMISSION_OC_PROJECT,

  ebisWinREVENUE:state.DesReducerBMD.ebisWinREVENUE,
  ebisWinProject:state.DesReducerBMD.ebisWinProject,
  ebisWIN_GTMA: state.DesReducerBMD.ebisWIN_GTMA,
  ebisWIN_GTMA_PROJECT: state.DesReducerBMD.ebisWIN_GTMA_PROJECT,
  ebisWIN_OC: state.DesReducerBMD.ebisWIN_OC,
  ebisWIN_OC_PROJECT: state.DesReducerBMD.ebisWIN_OC_PROJECT,

  ebisBillcomREVENUE:state.DesReducerBMD.ebisBillcomREVENUE,
  ebisBillcomeProject:state.DesReducerBMD.ebisBillcomeProject,
  ebisBILLCOM_GTMA: state.DesReducerBMD.ebisBILLCOM_GTMA,
  ebisBILLCOM_GTMA_PROJECT: state.DesReducerBMD.ebisBILLCOM_GTMA_PROJECT,
  ebisBILLCOM_OC: state.DesReducerBMD.ebisBILLCOM_OC,
  ebisBILLCOM_OC_PROJECT: state.DesReducerBMD.ebisBILLCOM_OC_PROJECT,

  //submission status
  SubmissionWINRevenue:state.DesReducerBMD.SubmissionWINRevenue,
  SubmissionWINProject:state.DesReducerBMD.SubmissionWINProject,
  SubmissionLOOSERevenue:state.DesReducerBMD.SubmissionLOOSERevenue,
  SubmissionLooseProject:state.DesReducerBMD.SubmissionLooseProject,
  SubmissionWaitingRevenue:state.DesReducerBMD.SubmissionWaitingRevenue,
  SubmissionWaitingProject:state.DesReducerBMD.SubmissionWaitingProject,
  SubmissionCancelRevenue:state.DesReducerBMD.SubmissionCancelRevenue,
  SubmissionCancekProject:state.DesReducerBMD.SubmissionCancekProject,

  //current status
  currentProspectRevenue:state.DesReducerBMD.currentProspectRevenue,
  currentProspectProject:state.DesReducerBMD.currentProspectProject,
  currentSubmissionRevenue:state.DesReducerBMD.currentSubmissionRevenue,
  currentSubmissionProject:state.DesReducerBMD.currentSubmissionProject,
  currentWINRevenue:state.DesReducerBMD.currentWINRevenue,
  currentWINProject:state.DesReducerBMD.currentWINProject,
  currentBIllcomRevenue:state.DesReducerBMD.currentBIllcomRevenue,
  currentBillcomProject:state.DesReducerBMD.currentBillcomProject,

  //data file download
  dataDownloadEbis:state.DesReducerBMD.dataDownloadEbis,
})
