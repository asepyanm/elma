...
class EbisDetailColumnProspectScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/EBIS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DES/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DBS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_BILLCOM_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DGS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail SUBS
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/EBIS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DES/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DBS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_BILLCOM_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DGS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail MITRA
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/EBIS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DES/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DBS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_BILLCOM_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DGS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    
    //get data detail TELKOM
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/EBIS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DES/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DBS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_BILLCOM_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/BILLCOM/deal/${namedeal}/div/DGS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
  }
  ...
  _toggleModal(item,div,maindiv){
    ...
    axios.get(`${url.API2}/ebis_getdeallistcc/stage/BILLCOM/categ/${maindiv}/deal/${namedeal}/div/${div}/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`).then((res) => {
...
const mapStateToProps = (state) => ({
  //data ebis
  ebisPROSPECT_GTMA: state.EbisReducerBMD.ebisBILLCOM_GTMA,
  ebisPROSPECT_GTMA_PROJECT: state.EbisReducerBMD.ebisBILLCOM_GTMA_PROJECT,
  ebisPROSPECT_OC: state.EbisReducerBMD.ebisBILLCOM_OC,
  ebisPROSPECT_OC_PROJECT: state.EbisReducerBMD.ebisBILLCOM_OC_PROJECT,

  //data des
  desPROSPECT_GTMA: state.DesReducerBMD.ebisBILLCOM_GTMA,
  desPROSPECT_GTMA_PROJECT: state.DesReducerBMD.ebisBILLCOM_GTMA_PROJECT,
  desPROSPECT_OC: state.DesReducerBMD.ebisBILLCOM_OC,
  desPROSPECT_OC_PROJECT: state.DesReducerBMD.ebisBILLCOM_OC_PROJECT,

  //data dbs
  dbsPROSPECT_GTMA: state.DbsReducerBMD.ebisBILLCOM_GTMA,
  dbsPROSPECT_GTMA_PROJECT: state.DbsReducerBMD.ebisBILLCOM_GTMA_PROJECT,
  dbsPROSPECT_OC: state.DbsReducerBMD.ebisBILLCOM_OC,
  dbsPROSPECT_OC_PROJECT: state.DbsReducerBMD.ebisBILLCOM_OC_PROJECT,

  //data dgs
  dgsPROSPECT_GTMA: state.DgsReducerBMD.ebisBILLCOM_GTMA,
  dgsPROSPECT_GTMA_PROJECT: state.DgsReducerBMD.ebisBILLCOM_GTMA_PROJECT,
  dgsPROSPECT_OC: state.DgsReducerBMD.ebisBILLCOM_OC,
  dgsPROSPECT_OC_PROJECT: state.DgsReducerBMD.ebisBILLCOM_OC_PROJECT,
