...
class EbisDetailColumnProspectScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/EBIS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DES/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DBS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DGS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/EBIS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DES/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DBS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DGS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/EBIS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DES/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DBS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DGS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/EBIS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DES',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DES/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DBS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DBS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DGS',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DGS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
  }
  ...
  _toggleModal(item,div,maindiv){
    ...
    RNFetchBlob.config({
      trusty:true
    }). fetch('GET', `${url.API2}/ebis_getdeallistcc/stage/SUBMISSION/categ/${maindiv}/deal/${namedeal}/div/${div}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`)
    .then((res) => {
