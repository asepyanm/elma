...
class EbisDetailColumnProspectScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/EBIS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DES/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DBS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBMISSION_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DGS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail SUBS
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/EBIS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DES/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DBS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_SUBMISSION_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DGS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail MITRA
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/EBIS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DES/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DBS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_SUBMISSION_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DGS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    
    //get data detail TELKOM
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/EBIS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DES/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DBS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_SUBMISSION_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/SUBMISSION/deal/${namedeal}/div/DGS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
  }
  ...
  _toggleModal(item,div,maindiv){
    ...
    axios.get(`${url.API2}/ebis_getdeallistcc/stage/SUBMISSION/categ/${maindiv}/deal/${namedeal}/div/${div}/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`).then((res) => {
    ...
    return(
      ...
      <View style={{backgroundColor:'#FFF', flex:1}}>
        <View style={styles.wrapperArrow}>
					<View style={{backgroundColor:'#ecb889'}}>
...
const mapStateToProps = (state) => ({
  //data ebis
  ebisPROSPECT_GTMA: state.EbisReducerBMD.ebisSUBMISSION_GTMA,
  ebisPROSPECT_GTMA_PROJECT: state.EbisReducerBMD.ebisSUBMISSION_GTMA_PROJECT,
  ebisPROSPECT_NGTMA: state.EbisReducerBMD.ebisSUBMISSION_NGTMA,
  ebisPROSPECT_NGTMA_PROJECT: state.EbisReducerBMD.ebisSUBMISSION_NGTMA_PROJECT,
  ebisPROSPECT_OC: state.EbisReducerBMD.ebisSUBMISSION_OC,
  ebisPROSPECT_OC_PROJECT: state.EbisReducerBMD.ebisSUBMISSION_OC_PROJECT,

  //data des
  desPROSPECT_GTMA: state.DesReducerBMD.ebisSUBMISSION_GTMA,
  desPROSPECT_GTMA_PROJECT: state.DesReducerBMD.ebisSUBMISSION_GTMA_PROJECT,
  desPROSPECT_NGTMA: state.DesReducerBMD.ebisSUBMISSION_NGTMA,
  desPROSPECT_NGTMA_PROJECT: state.DesReducerBMD.ebisSUBMISSION_NGTMA_PROJECT,
  desPROSPECT_OC: state.DesReducerBMD.ebisSUBMISSION_OC,
  desPROSPECT_OC_PROJECT: state.DesReducerBMD.ebisSUBMISSION_OC_PROJECT,

  //data dbs
  dbsPROSPECT_GTMA: state.DbsReducerBMD.ebisSUBMISSION_GTMA,
  dbsPROSPECT_GTMA_PROJECT: state.DbsReducerBMD.ebisSUBMISSION_GTMA_PROJECT,
  dbsPROSPECT_NGTMA: state.DbsReducerBMD.ebisSUBMISSION_NGTMA,
  dbsPROSPECT_NGTMA_PROJECT: state.DbsReducerBMD.ebisSUBMISSION_NGTMA_PROJECT,
  dbsPROSPECT_OC: state.DbsReducerBMD.ebisSUBMISSION_OC,
  dbsPROSPECT_OC_PROJECT: state.DbsReducerBMD.ebisSUBMISSION_OC_PROJECT,

  //data dgs
  dgsPROSPECT_GTMA: state.DgsReducerBMD.ebisSUBMISSION_GTMA,
  dgsPROSPECT_GTMA_PROJECT: state.DgsReducerBMD.ebisSUBMISSION_GTMA_PROJECT,
  dgsPROSPECT_NGTMA: state.DgsReducerBMD.ebisSUBMISSION_NGTMA,
  dgsPROSPECT_NGTMA_PROJECT: state.DgsReducerBMD.ebisSUBMISSION_NGTMA_PROJECT,
  dgsPROSPECT_OC: state.DgsReducerBMD.ebisSUBMISSION_OC,
  dgsPROSPECT_OC_PROJECT: state.DgsReducerBMD.ebisSUBMISSION_OC_PROJECT,
