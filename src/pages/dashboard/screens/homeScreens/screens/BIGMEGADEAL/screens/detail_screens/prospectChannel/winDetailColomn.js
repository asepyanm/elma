...
class EbisDetailColumnProspectScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/EBIS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DES/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DBS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DGS/categ/ALL/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail SUBS
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/EBIS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DES/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DBS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DGS/categ/SUBS/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail MITRA
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/EBIS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DES/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DBS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DGS/categ/MITRA/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    
    //get data detail TELKOM
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/EBIS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DES/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DBS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DGS/categ/TELKOM/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
  }
  ...
  _toggleModal(item,div,maindiv){
    ...
    axios.get(`${url.API2}/ebis_getdeallistcc/stage/WIN/categ/${maindiv}/deal/${namedeal}/div/${div}/startdate/${this.state.startdate}/enddate/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`).then((res) => {
