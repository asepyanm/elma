...
class EbisDetailColumnProspectScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/EBIS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DES/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DBS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DGS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail SUBS
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/EBIS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DES/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DBS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DGS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail MITRA
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/EBIS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DES/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DBS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DGS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    
    //get data detail TELKOM
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/EBIS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DES/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DBS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/${namedeal}/div/DGS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
  }
  ...
  _toggleModal(item,div,maindiv){
    ...
    axios.get(`${url.API2}/ebis_getdeallistcc/stage/WIN/categ/${maindiv}/deal/${namedeal}/div/${div}/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`).then((res) => {
...
const mapStateToProps = (state) => ({
  //data ebis
  ebisPROSPECT_GTMA: state.EbisReducerBMD.ebisWIN_GTMA,
  ebisPROSPECT_GTMA_PROJECT: state.EbisReducerBMD.ebisWIN_GTMA_PROJECT,
  ebisPROSPECT_NGTMA: state.EbisReducerBMD.ebisWIN_NGTMA,
  ebisPROSPECT_NGTMA_PROJECT: state.EbisReducerBMD.ebisWIN_NGTMA_PROJECT,
  ebisPROSPECT_OC: state.EbisReducerBMD.ebisWIN_OC,
  ebisPROSPECT_OC_PROJECT: state.EbisReducerBMD.ebisWIN_OC_PROJECT,

  //data des
  desPROSPECT_GTMA: state.DesReducerBMD.ebisWIN_GTMA,
  desPROSPECT_GTMA_PROJECT: state.DesReducerBMD.ebisWIN_GTMA_PROJECT,
  desPROSPECT_NGTMA: state.DesReducerBMD.ebisWIN_NGTMA,
  desPROSPECT_NGTMA_PROJECT: state.DesReducerBMD.ebisWIN_NGTMA_PROJECT,
  desPROSPECT_OC: state.DesReducerBMD.ebisWIN_OC,
  desPROSPECT_OC_PROJECT: state.DesReducerBMD.ebisWIN_OC_PROJECT,

  //data dbs
  dbsPROSPECT_GTMA: state.DbsReducerBMD.ebisWIN_GTMA,
  dbsPROSPECT_GTMA_PROJECT: state.DbsReducerBMD.ebisWIN_GTMA_PROJECT,
  dbsPROSPECT_NGTMA: state.DbsReducerBMD.ebisWIN_NGTMA,
  dbsPROSPECT_NGTMA_PROJECT: state.DbsReducerBMD.ebisWIN_NGTMA_PROJECT,
  dbsPROSPECT_OC: state.DbsReducerBMD.ebisWIN_OC,
  dbsPROSPECT_OC_PROJECT: state.DbsReducerBMD.ebisWIN_OC_PROJECT,

  //data dgs
  dgsPROSPECT_GTMA: state.DgsReducerBMD.ebisWIN_GTMA,
  dgsPROSPECT_GTMA_PROJECT: state.DgsReducerBMD.ebisWIN_GTMA_PROJECT,
  dgsPROSPECT_NGTMA: state.DgsReducerBMD.ebisWIN_NGTMA,
  dgsPROSPECT_NGTMA_PROJECT: state.DgsReducerBMD.ebisWIN_NGTMA_PROJECT,
  dgsPROSPECT_OC: state.DgsReducerBMD.ebisWIN_OC,
  dgsPROSPECT_OC_PROJECT: state.DgsReducerBMD.ebisWIN_OC_PROJECT,
