...
const mapStateToProps = (state) => ({
  lastUpdated: state.DgsReducerBMD.ebisLastupdate,

  //data dgs
  ebisProspectREVENUE:state.DgsReducerBMD.ebisProspectREVENUE,
  ebisProspectProject:state.DgsReducerBMD.ebisProspectProject,
  ebisPROSPECT_GTMA: state.DgsReducerBMD.ebisPROSPECT_GTMA,
  ebisPROSPECT_GTMA_PROJECT: state.DgsReducerBMD.ebisPROSPECT_GTMA_PROJECT,
  PROSPECT_OC: state.DgsReducerBMD.PROSPECT_OC,
  PROSPECT_OC_PROJECT: state.DgsReducerBMD.PROSPECT_OC_PROJECT,

  ebisSubmisionREVENUE:state.DgsReducerBMD.ebisSubmisionREVENUE,
  ebisSubmissionProject:state.DgsReducerBMD.ebisSubmissionProject,
  ebisSUBMISSION_GTMA:state.DgsReducerBMD.ebisSUBMISSION_GTMA,
  ebisSUBMISSION_GTMA_PROJECT:state.DgsReducerBMD.ebisSUBMISSION_GTMA_PROJECT,
  ebisSUBMISSION_OC: state.DgsReducerBMD.ebisSUBMISSION_OC,
  ebisSUBMISSION_OC_PROJECT: state.DgsReducerBMD.ebisSUBMISSION_OC_PROJECT,

  ebisWinREVENUE:state.DgsReducerBMD.ebisWinREVENUE,
  ebisWinProject:state.DgsReducerBMD.ebisWinProject,
  ebisWIN_GTMA: state.DgsReducerBMD.ebisWIN_GTMA,
  ebisWIN_GTMA_PROJECT: state.DgsReducerBMD.ebisWIN_GTMA_PROJECT,
  ebisWIN_OC: state.DgsReducerBMD.ebisWIN_OC,
  ebisWIN_OC_PROJECT: state.DgsReducerBMD.ebisWIN_OC_PROJECT,

  ebisBillcomREVENUE:state.DgsReducerBMD.ebisBillcomREVENUE,
  ebisBillcomeProject:state.DgsReducerBMD.ebisBillcomeProject,
  ebisBILLCOM_GTMA: state.DgsReducerBMD.ebisBILLCOM_GTMA,
  ebisBILLCOM_GTMA_PROJECT: state.DgsReducerBMD.ebisBILLCOM_GTMA_PROJECT,
  ebisBILLCOM_OC: state.DgsReducerBMD.ebisBILLCOM_OC,
  ebisBILLCOM_OC_PROJECT: state.DgsReducerBMD.ebisBILLCOM_OC_PROJECT,

  //submission status
  SubmissionWINRevenue:state.DgsReducerBMD.SubmissionWINRevenue,
  SubmissionWINProject:state.DgsReducerBMD.SubmissionWINProject,
  SubmissionLOOSERevenue:state.DgsReducerBMD.SubmissionLOOSERevenue,
  SubmissionLooseProject:state.DgsReducerBMD.SubmissionLooseProject,
  SubmissionWaitingRevenue:state.DgsReducerBMD.SubmissionWaitingRevenue,
  SubmissionWaitingProject:state.DgsReducerBMD.SubmissionWaitingProject,
  SubmissionCancelRevenue:state.DgsReducerBMD.SubmissionCancelRevenue,
  SubmissionCancekProject:state.DgsReducerBMD.SubmissionCancekProject,

  //current status
  currentProspectRevenue:state.DgsReducerBMD.currentProspectRevenue,
  currentProspectProject:state.DgsReducerBMD.currentProspectProject,
  currentSubmissionRevenue:state.DgsReducerBMD.currentSubmissionRevenue,
  currentSubmissionProject:state.DgsReducerBMD.currentSubmissionProject,
  currentWINRevenue:state.DgsReducerBMD.currentWINRevenue,
  currentWINProject:state.DgsReducerBMD.currentWINProject,
  currentBIllcomRevenue:state.DgsReducerBMD.currentBIllcomRevenue,
  currentBillcomProject:state.DgsReducerBMD.currentBillcomProject,

  //data file download
  dataDownloadEbis:state.DgsReducerBMD.dataDownloadEbis,
})
