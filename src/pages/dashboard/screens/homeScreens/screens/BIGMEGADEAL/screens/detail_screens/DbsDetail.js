...
class DbsDetailScreens extends Component{
  ...
  componentWillMount(){
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/EBIS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DES/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DBS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DGS/categ/ALL/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail SUBS
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/EBIS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DES/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DBS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_SUBS_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DGS/categ/SUBS/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });

    //get data detail MITRA
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/EBIS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DES/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DBS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_MITRA_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DGS/categ/MITRA/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    
    //get data detail TELKOM
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_EBIS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/EBIS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DES',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DES/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DBS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DBS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    });
    this.props.dispatch({
      type:'DETAIL_TELKOM_WIN_DGS',
      payload:axios.get(`${url.API2}/ebis_getdeallistsub/stage/WIN/deal/ALL/div/DGS/categ/TELKOM/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/${this.state.reg}/witel/${this.state.witel}`)
    }); 
  ...
  _toggleModal(item,div,maindiv){
    ...
    axios.get(`${url.API2}/ebis_getdeallistcc/stage/WIN/categ/${maindiv}/deal/ALL/div/${div}/start_date/${this.state.startdate}/end_date/${this.state.enddate}/treg/ALL/witel/ALL/mitra/${item}`).then((res) => {
