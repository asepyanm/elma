...
class DbsScreens extends Component{
  ...
  refreshPeriode(sDate,eDate){
    ...
    this.props.dispatch({
      type:'DBS_HOME_BMD',
      payload:axios.get(`${url.API2}/ebis_getdealmain/div/DBS/startdate/${sDate}/enddate/${eDate}/treg/ALL/witel/ALL/`)
    });
    this.props.dispatch({
    ...
    this.props.dispatch({
      ...
      payload:axios.get(`${url.API2}/ebis_getdealsub/startdate/${sDate}/enddate/${eDate}/div/DBS/treg/ALL/witel/ALL/`)
    });

    this.props.dispatch({
      type:'DBS_HOME_DOWNLOAD_BMD',
      payload:axios.get(`${url.API2}/ebis_getdealrawdata/startdate/${sDate}/enddate/${eDate}/div/DBS/treg/ALL/witel/ALL`)
    });
