  ...
  refreshPeriode(sDate,eDate){
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getdealmain/div/DBS/startdate/${sDate}/enddate/${eDate}/treg/ALL/witel/ALL/`),
    });
    this.props.dispatch({
      type:'DBS_HOME_CURRENT_BMD',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getdealcurr/div/DBS/treg/ALL/witel/ALL/`),
    });
    this.props.dispatch({
      type:'DBS_HOME_SUBMISSION_BMD',
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getdealsub/startdate/${sDate}/enddate/${eDate}/div/DBS/treg/ALL/witel/ALL/`),
    });
    ...
    this.props.dispatch({
      ...
      payload:RNFetchBlob.config({
        trusty:true
      }). fetch('GET', `${url.API}/ebis_getdealrawdata/startdate/${sDate}/enddate/${eDate}/div/DBS/treg/ALL/witel/ALL`),
    });

    this.props.dispatch({
      type:'DBS_LASTUPDATE_BMD',
      payload:RNFetchBlob.config({
        trusty:true
...
const mapStateToProps = (state) => ({
  lastUpdated: state.DbsReducerBMD.ebisLastupdate,

  //data dbs
  ebisProspectREVENUE:state.DbsReducerBMD.ebisProspectREVENUE,
  ebisProspectProject:state.DbsReducerBMD.ebisProspectProject,
  ebisPROSPECT_GTMA: state.DbsReducerBMD.ebisPROSPECT_GTMA,
  ebisPROSPECT_GTMA_PROJECT: state.DbsReducerBMD.ebisPROSPECT_GTMA_PROJECT,
  PROSPECT_OC: state.DbsReducerBMD.PROSPECT_OC,
  PROSPECT_OC_PROJECT: state.DbsReducerBMD.PROSPECT_OC_PROJECT,

  ebisSubmisionREVENUE:state.DbsReducerBMD.ebisSubmisionREVENUE,
  ebisSubmissionProject:state.DbsReducerBMD.ebisSubmissionProject,
  ebisSUBMISSION_GTMA:state.DbsReducerBMD.ebisSUBMISSION_GTMA,
  ebisSUBMISSION_GTMA_PROJECT:state.DbsReducerBMD.ebisSUBMISSION_GTMA_PROJECT,
  ebisSUBMISSION_OC: state.DbsReducerBMD.ebisSUBMISSION_OC,
  ebisSUBMISSION_OC_PROJECT: state.DbsReducerBMD.ebisSUBMISSION_OC_PROJECT,

  ebisWinREVENUE:state.DbsReducerBMD.ebisWinREVENUE,
  ebisWinProject:state.DbsReducerBMD.ebisWinProject,
  ebisWIN_GTMA: state.DbsReducerBMD.ebisWIN_GTMA,
  ebisWIN_GTMA_PROJECT: state.DbsReducerBMD.ebisWIN_GTMA_PROJECT,
  ebisWIN_OC: state.DbsReducerBMD.ebisWIN_OC,
  ebisWIN_OC_PROJECT: state.DbsReducerBMD.ebisWIN_OC_PROJECT,

  ebisBillcomREVENUE:state.DbsReducerBMD.ebisBillcomREVENUE,
  ebisBillcomeProject:state.DbsReducerBMD.ebisBillcomeProject,
  ebisBILLCOM_GTMA: state.DbsReducerBMD.ebisBILLCOM_GTMA,
  ebisBILLCOM_GTMA_PROJECT: state.DbsReducerBMD.ebisBILLCOM_GTMA_PROJECT,
  ebisBILLCOM_OC: state.DbsReducerBMD.ebisBILLCOM_OC,
  ebisBILLCOM_OC_PROJECT: state.DbsReducerBMD.ebisBILLCOM_OC_PROJECT,

  //submission status
  SubmissionWINRevenue:state.DbsReducerBMD.SubmissionWINRevenue,
  SubmissionWINProject:state.DbsReducerBMD.SubmissionWINProject,
  SubmissionLOOSERevenue:state.DbsReducerBMD.SubmissionLOOSERevenue,
  SubmissionLooseProject:state.DbsReducerBMD.SubmissionLooseProject,
  SubmissionWaitingRevenue:state.DbsReducerBMD.SubmissionWaitingRevenue,
  SubmissionWaitingProject:state.DbsReducerBMD.SubmissionWaitingProject,
  SubmissionCancelRevenue:state.DbsReducerBMD.SubmissionCancelRevenue,
  SubmissionCancekProject:state.DbsReducerBMD.SubmissionCancekProject,

  //current status
  currentProspectRevenue:state.DbsReducerBMD.currentProspectRevenue,
  currentProspectProject:state.DbsReducerBMD.currentProspectProject,
  currentSubmissionRevenue:state.DbsReducerBMD.currentSubmissionRevenue,
  currentSubmissionProject:state.DbsReducerBMD.currentSubmissionProject,
  currentWINRevenue:state.DbsReducerBMD.currentWINRevenue,
  currentWINProject:state.DbsReducerBMD.currentWINProject,
  currentBIllcomRevenue:state.DbsReducerBMD.currentBIllcomRevenue,
  currentBillcomProject:state.DbsReducerBMD.currentBillcomProject,

  //data file download
  dataDownloadEbis:state.DbsReducerBMD.dataDownloadEbis,
})
