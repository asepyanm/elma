...
const DgsReducerChannel = (state = initialState, action) => {
  switch (action.type) {
    ...
    //reducer data ebis
    case 'DGS_HOME_CHANNEL_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
    ...
    //reducer submission 
    case 'DGS_HOME_SUBMISSION_CHANNEL_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'DGS_HOME_SUBMISSION_CHANNEL_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    //reducer current
    case 'DGS_HOME_CURRENT_CHANNEL_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'DGS_HOME_CURRENT_CHANNEL_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'DGS_HOME_DOWNLOAD_CHANNEL_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'DGS_HOME_DOWNLOAD_CHANNEL_PENDING':
      return{
        ...state, 
      }
    break;
...
export default DgsReducerChannel;