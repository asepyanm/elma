...
const EbisReducerChannel = (state = initialState, action) => {
  switch (action.type) {

    //data last update 
    case 'EBIS_LASTUPDATE_CHANNEL_FULFILLED':
      return {
        ...state, 
    ...
    //reducer data ebis
    case 'EBIS_HOME_CHANNEL_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
    ...
    case 'EBIS_HOME_CHANNEL_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'EBIS_HOME_CHANNEL_FULFILLED':
      return {
        ...state, 
        loaderStatus:false,
    ...
    //reducer submission 
    case 'EBIS_HOME_SUBMISSION_CHANNEL_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'EBIS_HOME_SUBMISSION_CHANNEL_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'EBIS_HOME_SUBMISSION_CHANNEL_FULFILLED':
      return{
        ...state, 
        //Current status
    ...
    //reducer current
    case 'EBIS_HOME_CURRENT_CHANNEL_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'EBIS_HOME_CURRENT_CHANNEL_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'EBIS_HOME_CURRENT_CHANNEL_FULFILLED':
      return{
        ...state, 
        //Current status
    ...
    case 'EBIS_HOME_DOWNLOAD_CHANNEL_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'EBIS_HOME_DOWNLOAD_CHANNEL_PENDING':
      return{
        ...state, 
      }
    break;

    case 'EBIS_HOME_DOWNLOAD_CHANNEL_FULFILLED':
      return {
        ...state, 
...
export default EbisReducerChannel;