...
const DesReducerBMD = (state = initialState, action) => {
  switch (action.type) {
    ...
    //reducer submission 
    case 'DES_HOME_SUBMISSION_BMD_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'DES_HOME_SUBMISSION_BMD_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    //reducer current
    case 'DES_HOME_CURRENT_BMD_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'DES_HOME_CURRENT_BMD_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'DES_HOME_DOWNLOAD_BMD_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'DES_HOME_DOWNLOAD_BMD_PENDING':
      return{
        ...state, 
      }
    break;
