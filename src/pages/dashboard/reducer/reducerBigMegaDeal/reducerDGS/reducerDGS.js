...
const DgsReducerBMD = (state = initialState, action) => {
  switch (action.type) {

    //data last update 
    case 'DGS_LASTUPDATE_BMD_FULFILLED':
    ...
    //reducer submission 
    case 'DGS_HOME_SUBMISSION_BMD_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'DGS_HOME_SUBMISSION_BMD_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'DGS_HOME_SUBMISSION_BMD_FULFILLED':
    ...
    //reducer current
    case 'DGS_HOME_CURRENT_BMD_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'DGS_HOME_CURRENT_BMD_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'DGS_HOME_CURRENT_BMD_FULFILLED':
    ...
    case 'DGS_HOME_DOWNLOAD_BMD_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'DGS_HOME_DOWNLOAD_BMD_PENDING':
      return{
        ...state, 
      }
    break;

    case 'DGS_HOME_DOWNLOAD_BMD_FULFILLED':
