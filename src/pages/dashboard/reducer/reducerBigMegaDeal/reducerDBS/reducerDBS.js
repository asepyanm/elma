...
const DbsReducerBMD = (state = initialState, action) => {
  switch (action.type) {

    //data last update 
    case 'DBS_LASTUPDATE_BMD_FULFILLED':
    ...
    //reducer submission 
    case 'DBS_HOME_SUBMISSION_BMD_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'DBS_HOME_SUBMISSION_BMD_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'DBS_HOME_SUBMISSION_BMD_FULFILLED':
    ...
    //reducer current
    case 'DBS_HOME_CURRENT_BMD_REJECTED':
      return{
        ...state, 
        loaderStatus:false,
        statusErrorFrom:false,
    ...
    case 'DBS_HOME_CURRENT_BMD_PENDING':
      return{
        ...state, 
        loaderStatus:true,
      }
    ...
    case 'DBS_HOME_CURRENT_BMD_FULFILLED':
    ...
    case 'DBS_HOME_DOWNLOAD_BMD_REJECTED':
      return{
        ...state, 
      }
    break;
    
    case 'DBS_HOME_DOWNLOAD_BMD_PENDING':
      return{
        ...state, 
      }
    break;

    case 'DBS_HOME_DOWNLOAD_BMD_FULFILLED':
