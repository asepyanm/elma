    ...
    switch (action.type) {
      ...
      case 'MONITOR_KB_DGS_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
          dataDgsWinSubs:action.payload.data[0].KB_REV,
          dataDgsWPSubs: action.payload.data[0].KB_PROJECT
        }
      break;
      case 'MONITOR_KB_DGS_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
          dataDgsWinMitra:action.payload.data[0].KB_REV,
          dataDgsWPMitra: action.payload.data[0].KB_PROJECT
        }
      break;
