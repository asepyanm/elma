    ...
    switch (action.type) {
      ...
      case 'MONITOR_KB_DBS_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
          dataDbsWinSubs:action.payload.data[0].KB_REV,
          dataDbsWPSubs: action.payload.data[0].KB_PROJECT
        }
      break;
      case 'MONITOR_KB_DBS_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
          dataDbsWinMitra:action.payload.data[0].KB_REV,
          dataDbsWPMitra: action.payload.data[0].KB_PROJECT
        }
      break;
