const initialState = { 
  ...
  const MonitorEbisReducerKL = (state = initialState, action) => {
    switch (action.type) {
      ...
      break;
      case 'MONITOR_KL_EBIS_SUBS_FULFILLED':
          const dataJSON2 = JSON.parse(action.payload.data)

        return{
          ...state, 
          //Current status
          dataEbisWinSubs:dataJSON2[0].WINREV,
          dataEbisWPSubs: dataJSON2[0].WINPROJECT
        }
      break;
      case 'MONITOR_KL_EBIS_MITRA_FULFILLED':
          const dataJSON3 = JSON.parse(action.payload.data)

        return{
          ...state, 
          //Current status
          dataEbisWinMitra:dataJSON3[0].WINREV,
          dataEbisWPMitra: dataJSON3[0].WINPROJECT
        }
      break;
      case 'MONITOR_KL_EBIS_TELKOM_FULFILLED':
        ...
        return{
          ...
          dataEbisWPTelkom: dataJSON4[0].KB_PROJECT
        }
      break;
      ...
      break;
      case 'MONITOR_KL_EBIS_DONE_SUBS_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DONE_MITRA_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DONE_TELKOM_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_OGP_SUBS_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_OGP_MITRA_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_OGP_TELKOM_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_OGP_DATA_SUBS_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_OGP_DATA_MITRA_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_OGP_DATA_TELKOM_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_DONE_SUBS_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_DONE_MITRA_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_DONE_TELKOM_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_SUBS_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_MITRA_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_TELKOM_FULFILLED':
      ...
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_3_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_3_SUBS_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_3_MITRA_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_3_TELKOM_FULFILLED':
      ...
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_6_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_6_SUBS_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_6_MITRA_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_6_TELKOM_FULFILLED':
      ...
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_7_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_7_SUBS_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_7_MITRA_FULFILLED':
      ...
      break;
      case 'MONITOR_KL_EBIS_DETAIL_OGP_PROGRESS_7_TELKOM_FULFILLED':
