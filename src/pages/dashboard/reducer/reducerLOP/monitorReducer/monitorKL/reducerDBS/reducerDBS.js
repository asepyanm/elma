    ...
    switch (action.type) {
      ...
      case 'MONITOR_KL_DBS_FULFILLED':
        return{
          ...state, 
          //Current status
          dataDbsWin:action.payload.data[0].KB_REV,
          dataDbsWP: action.payload.data[0].KB_PROJECT
        }
      break;
      case 'MONITOR_KL_DBS_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
          dataDbsWinTelkom:action.payload.data[0].KB_REV,
          dataDbsWPTelkom: action.payload.data[0].KB_PROJECT
        }
      break;
      ...
      break;
      case 'MONITOR_KL_DBS_DONE_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DONE_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DONE_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_OGP_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_OGP_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_OGP_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_OGP_DATA_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_OGP_DATA_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_OGP_DATA_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_DONE_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_DONE_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_DONE_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_3_FULFILLED':
      return{
        ...state, 
        //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_3_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_3_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_3_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_6_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_6_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_6_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_6_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_7_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_7_SUBS_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_7_MITRA_FULFILLED':
        return{
          ...state, 
          //Current status
      ...
      break;
      case 'MONITOR_KL_DBS_DETAIL_OGP_PROGRESS_7_TELKOM_FULFILLED':
        return{
          ...state, 
          //Current status
